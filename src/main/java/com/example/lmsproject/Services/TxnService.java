...
import com.example.lmsproject.repositories.TransactionRepository;
...
//        logger.info("After sleeping in Issue request came: studentId - {}, bookId - {}", studentId, bookId);
        ...
        List<Book> books = bookService.findByCriteria(BookFilterType.BOOK_ID, String.valueOf(bookId));
        ...
        bookService.createOrUpdateFromBook(books.get(0));
